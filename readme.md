...
**AutoCraft Bot 1.1.9beta1** - программа для управления и мониторинга компьютера на **Windows**.
...
## Что нового в версии 1.1.9beta1

В версии **1.1.9beta1** AutoCraft Bot получил не только развитие веб-панели, но и ряд практических доработок для повседневной удалённой работы с системой. Проект стал удобнее как для администрирования, так и для обычных сервисных задач.
...
### Основные изменения в 1.1.9beta1

- Добавлена **отправка клавиатурных комбинаций** для удалённого управления системой через веб-панель.
- Добавлено **отображение температур** комплектующих, что делает мониторинг состояния ПК более информативным.
- **Удалённый рабочий стол** доработан: улучшена стабильность и общий сценарий использования.
- Реализована **установка расширений уже в скомпилированном варианте**, без необходимости пересобирать программу вручную.
- Продолжено развитие веб-панели как отдельного интерфейса для управления и мониторинга Windows-компьютера.

> Важно: версия **1.1.9beta1** остаётся тестовой, поэтому отдельные функции ещё могут дорабатываться.

---

## Что умеет

### Веб-панель (1.1.9beta1)
...
- ✅ Веб (beta): прямая трансляция с камер и доработанный удалённый рабочий стол.
- ✅ Роли и пользователи в веб-панели: разграничение доступа и администрирование.
- ✅ Отправка клавиатурных комбинаций через веб-панель для удалённого управления.
- ✅ Отображение температур комплектующих в мониторинге.
...
- ✅ Установка расширений доступна и в **скомпилированной версии** программы.
...
> В EXE-режиме можно **добавлять, устанавливать и удалять расширения и плагины** (папка `plugins/`) **без перекомпиляции**.
