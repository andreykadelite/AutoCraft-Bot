...
**AutoCraft Bot** — Windows‑приложение + Telegram‑бот для удалённого управления своим компьютером и набора системных утилит.  
Управление сделано “по‑Нормальному”: **всё через кнопки Telegram** (ReplyKeyboard), поэтому удобно на телефоне и нормально работает со **скринридерами** (TalkBack/VoiceOver/NVDA).
